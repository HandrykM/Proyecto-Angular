...
subiendoArchivo: boolean = false;
  ...
  // ✅ AGREGAR: Configuración responsive general
  setTimeout(() => {
    this.inicializarResponsive();

    // ✅ Configurar menú responsive horizontal desde la derecha
...
private inicializarResponsive(): void {
  this.setupMenuHamburguesa();
  this.setupSidebarMobile();
  this.setupEventosResize();
 ...
 */
private setupMenuHamburguesa(): void {
    const toggle = document.getElementById('navToggle');
    const menu = document.querySelector('.nav-menu');
 ...
 */
private setupSidebarMobile(): void {
  ...
  // Cerrar sidebar al hacer clic en botones
 ...
 * Configurar eventos de resize
 */
private setupEventosResize(): void {
  window.addEventListener('resize', this.handleResize);
  
  // Fix para iOS
  this.ajustarAlturaVentana();
...
/**
 * Ajustar altura de ventana (fix iOS)
 */
private ajustarAlturaVentana(): void {
...
inicializarFormRecurso(): void {
  ...
  toggleSidebar(): void {
    ...
    console.log('Sidebar:', this.sidebarAbierta ? 'abierto' : 'cerrado');
  }
